        ...
        <div class="sub_main">
            <div class="short_links flex" style="justify-content:center; ">
                ...
                <ul>
                    ...
                    <li>+91 98562147</li>
                    <li>contact@booknookhaven.com</li>
                    <li>Address: HP 176081</li>
                </ul>

            </div>
        </div>
        <div style=" align-items:center; justify-content:center; margin:20px 0 0 ;" class="cmsg flex">
            <p>Designed By Sanyam Sharma  | Copyright &copy; <script>
                    document.write(new Date().getFullYear())
                </script> All Rights are reserved by &nbsp</p>
            <div style="font-size: 30px;" class="logo">
                <a href="index.php"><span style="font-size: 15px;">BookNook</span>
                    <span class="me" style="font-size: 15px;">Haven</span></a>
            </div> 
        </div>
    </div>
</footer>